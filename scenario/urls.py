...
urlpatterns = patterns('scenario.views',
                       ...
                       (r'^actiongraph/add/(?P<scenario_id>\d+)/(?P<action_id>\d+)/$', 'action_graph_add'),
                       (r'^actiongraph/del/(?P<scenario_id>\d+)/(?P<graph_id>\d+)/$', 'delete_action_from_graph'),
                       (r'^actor/insert/to/action/(?P<scenario_id>\d+)/(?P<action_id>\d+)/$', 'insert_actors_to_action'),
                       (r'^association/delete/(?P<association_id>\d+)/$', 'delete_actor_action'),
                       (r'^visualization/action/(?P<action_id>\d+)/$', 'visualization'),
