...
DATABASES = {
    'default': {
        ...
        'NAME': 'transafe_test',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'transafe_dev',
        'PASSWORD': 'tran@safe.alp',
        'HOST': 'geopg',          # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
        'PORT': '5432',          # Set to empty string for default.
    }
}

ALLOWED_HOSTS = ['localhost','transafealp.fbk.eu']
...
USE_L10N = True
USE_TZ = True
MEDIA_ROOT = '/www/transafealp/media/'
MEDIA_URL = '/media/'
# Absolute path to the directory static files should be collected to.
# Don't put anything in this directory yourself; store your static files
# in apps' "static/" subdirectories and in STATICFILES_DIRS.
# Example: "/var/www/example.com/static/"
STATIC_ROOT = '/www/transafealp/static/'
